...
public class ProductServiceIntegrationTest {
    ...
    public void setUp() {
        ...
        product1 = new Product("Product1", "description1", "picture1", money1, 10, 10, categories);
        product2 = new Product("Product2", "description2", "picture2", money1, 10, 10, categories);
        product3 = new Product("Product3", "description3", "picture3", money1, 10, 10, categories);
